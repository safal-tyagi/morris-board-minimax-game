...
/**
 * Description: Plays in opening phase of the MiniMax game with Black moved first, board is flipped in this case
...
public class MiniMaxOpeningBlack {
	...
	public static Output MiniMax(Board board, int depth, boolean isBlack) {
		...
		List<Board> nextMoves = (isBlack) ? MorrisBoardGame.generateMovesOpeningBlack(board)
				: MorrisBoardGame.generateMovesOpening(board);
